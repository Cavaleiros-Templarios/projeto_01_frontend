...
const Sobre: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Imagens laterais absolutas */}
      <div className="flex mt-[150px] ml-10 w-full absolute">
        <img
          src="https://ik.imagekit.io/dmzx7is6a/FasGen/In%20no%20time-cuate%20(1).png?updatedAt=1751552616047"
          alt="Ilustração"
          className="w-1/5 mr-[10%] mt-[115rem]"
        />
      </div>
      <div className="flex justify-end mr-10 w-full absolute">
        <img
          src="https://ik.imagekit.io/dmzx7is6a/FasGen/In%20no%20time-pana.png?updatedAt=1751559560233"
          alt="Ilustração"
          className="w-1/5 mr-10 mt-[5rem]"
        />
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-[var(--cor-primaria)] mb-5">Sobre o FastGen</h1>
            <div className="rounded-lg shadow-lg px-10 py-10 mb-8">
              <p className="text-lg text-gray-600 leading-relaxed">
                O FastGen é uma plataforma inovadora de delivery que revoluciona a forma como você recebe seus produtos favoritos.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Com tecnologia de ponta e uma interface intuitiva, conectamos você aos melhores estabelecimentos da sua região.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Nosso compromisso é com a excelência no atendimento e a satisfação total dos nossos clientes.
              </p>
            </div>
          </div>
        </section>

      {/* Vídeo acima do Sobre o FastGen */}
      <div className="w-full flex justify-center mb-12">
        <div className="relative m-[5%] w-full max-w-4xl">
          <video
            src="https://ik.imagekit.io/dmzx7is6a/FasGen/V%C3%ADdeo_Loop_FastGen_Entrega_Moderna.mp4?updatedAt=1751558762348"
            autoPlay
            loop
            muted
            playsInline
            className="rounded-2xl w-full shadow-lg opacity-95"
          />
          {/* Borda por cima */}
          <div className="absolute opacity-90 top-1 left-1 w-full h-full rounded-2xl border-[40px] border-[var(--cor-primaria-fundo)] -m-1 pointer-events-none"></div>
        </div>
      </div>
